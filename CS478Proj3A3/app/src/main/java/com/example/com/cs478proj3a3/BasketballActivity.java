...
public class BasketballActivity extends AppCompatActivity implements ListSelectionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkPermissions()) {
            ...
            siteFragment.setSites(DataProvider.sitesNBA);
            ...
            tlf.setTeam(DataProvider.listNBA);
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        inflater.inflate(R.menu.basketball_menu, menu);
        return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        if(item.getItemId() == R.id.switchToBaseball){
            Toast.makeText(this, "Switching to Baseball", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, BaseballActivity.class);
            startActivity(i);
            return true;
        }
